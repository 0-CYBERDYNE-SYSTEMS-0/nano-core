...
test('message fetchers exclude assistant-origin and tui-sender rows without dropping user text', () => {
  ...
  try {
    ...
    storeHostMessage({
      ...
      chatJid: 'chat-1',
      sender: 'nano-core',
      senderName: 'nano-core',
      content: 'nano-core: Here is your update',
    ...
    storeHostMessage({
      ...
      sender: 'user@jid',
      senderName: 'User',
      content: 'nano-core: can you check irrigation?',
    ...
    storeHostMessage({
      ...
      sender: 'chat-1',
      senderName: 'chat-1',
      content: 'nano-core: outbound whatsapp echo',
    ...
    const { messages } = getNewMessages(['chat-1'], '', 'nano-core');
    const sinceRows = getMessagesSince('chat-1', '', 'nano-core');
...
test('getPromptTranscriptMessages preserves chronological assistant and user context', () => {
  ...
  try {
    ...
    storeHostMessage({
      ...
      sender: 'nano-core',
      senderName: 'nano-core',
      content: 'nano-core: here are the headlines',
      timestamp: '2026-03-22T10:00:01.000Z',
      isFromMe: true,
    });
    storeHostMessage({
