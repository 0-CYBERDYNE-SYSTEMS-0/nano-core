...
async function runAgent(
  ...
  try {
    ...
    const extraSystemPrompt = [
      ...
      'The following JSON is generated by nano-core host runtime for this specific run.',
  ...
  try {
    ...
    if (HEARTBEAT_TARGET_ACCOUNT_ID?.trim()) {
      logger.debug(
        ...
        'Heartbeat accountId configured but ignored (single-account channels in nano-core)',
      );
    }
